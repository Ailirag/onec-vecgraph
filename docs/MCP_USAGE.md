...
| Граф вызовов BSL | `callgraph` | find_callers, find_callees, call_path, find_handlers, **find_overrides**, и `entry_points`/`calls_by_kind` в metrics |
...
### Стандарты разработки 1С (v8std) — специализированные инструменты
