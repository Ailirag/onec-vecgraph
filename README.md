...
Для машины разработчика есть **lite-режим**: 31 инструмент (по умолчанию публикуются 22 —
...
Поэтому профиль по умолчанию (`lean`, 22 инструмента) не публикует `search_code`,
